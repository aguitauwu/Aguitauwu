...
<div class="header-section">
  <div class="header-content">
    ...
    <div class="contact-badges">
      <a href="https://github.com/aguitauwu" class="contact-badge">GitHub</a>
      <a href="https://github.com/OpceanAI" class="contact-badge">OpceanAI</a>
      <a href="https://github.com/YuuKi-OS" class="contact-badge">YuuKi-OS</a>
...
<div class="project-section">
  <div class="project-card">
    ...
    <p class="project-description">
      Advanced language model development startup. Creator of <span class="highlight">YuuKi RxG 8B</span>, an 8-billion parameter model achieving <span class="highlight">96.6% accuracy on TruthfulQA</span>. Focused on building efficient, reliable, and verifiable AI models with superior performance in reasoning and truthfulness evaluation.
    </p>
    <p style="margin-top: 12px;">
      <a href="https://github.com/OpceanAI" style="color: #ec4899; margin-right: 15px;">GitHub</a>
      <a href="https://huggingface.co/OpceanAI" style="color: #f59e0b;">Hugging Face</a>
    </p>
  </div>
  ...
  <div class="project-card">
    ...
    <p class="project-description">
      <span class="highlight">Vector Encrypted Xor Interference System</span> - Encryption system combining AI vector representations with quantization techniques. Integrates machine learning with cryptographic principles for a novel approach to data security.
    </p>
    <p style="margin-top: 12px;">
      <a href="https://huggingface.co/VEX-IS" style="color: #f59e0b;">Hugging Face</a>
    </p>
  </div>
  ...
  <div class="project-card">
    ...
    <p class="project-description">
      <span class="highlight">Not Humanity's Exam</span> - Specialized LLM benchmark measuring reasoning capabilities independent of learned human patterns. Evaluates model truthfulness and reasoning authenticity, ensuring outputs reflect genuine understanding rather than pattern memorization.
    </p>
    <p style="margin-top: 12px;">
      <a href="https://huggingface.co/Not-Humanity-Exam" style="color: #f59e0b;">Hugging Face</a>
    </p>
  </div>
  ...
  <div class="project-card">
    ...
    <p class="project-description">
      Enhanced fork of Forgejo with optimized user interface and expanded tooling. Designed to maximize developer experience with streamlined workflows and improved collaboration tools.
    </p>
  </div>
  ...
  <div class="project-card">
    ...
    <p class="project-description">
      Next-generation LLM training framework designed to overcome transformer limitations. Implements novel training methodologies achieving superior performance and scalability beyond traditional transformer approaches.
    </p>
  </div>
...
<div class="footer-text">
  <p>Built with passion, Python, and creativity | Made in Mexico | Mondongo lover</p>
</div>
